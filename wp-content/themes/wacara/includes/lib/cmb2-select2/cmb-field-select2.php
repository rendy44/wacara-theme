...
if ( ! class_exists( 'PW_CMB2_Field_Select2' ) ) {
	...
	class PW_CMB2_Field_Select2 {
		...
		public function __construct() {
			add_filter( 'cmb2_render_pw_select', [ $this, 'render_pw_select' ], 10, 5 );
			add_filter( 'cmb2_render_pw_multiselect', [ $this, 'render_pw_multiselect' ], 10, 5 );
			add_filter( 'cmb2_sanitize_pw_multiselect', [ $this, 'pw_multiselect_sanitize' ], 10, 4 );
			add_filter( 'cmb2_types_esc_pw_multiselect', [ $this, 'pw_multiselect_escaped_value' ], 10, 3 );
			add_filter( 'cmb2_repeat_table_row_types', [ $this, 'pw_multiselect_table_row_class' ], 10, 1 );
		}
		...
		public function setup_admin_scripts() {
			...
			wp_register_script( 'pw-select2', $asset_path . '/js/select2.min.js', [ 'jquery-ui-sortable' ], '4.0.3' );
			wp_enqueue_script( 'pw-select2-init', $asset_path . '/js/script.js', [
				'cmb2-scripts',
				'pw-select2',
			], self::VERSION, true );
			wp_register_style( 'pw-select2', $asset_path . '/css/select2.min.css', [], '4.0.3' );
			wp_enqueue_style( 'pw-select2-tweaks', $asset_path . '/css/style.css', [ 'pw-select2' ], self::VERSION );
		}
	}
