...
<header class="masthead <?php echo esc_attr( $header_extra_class[0] ); ?>" id="masthead" data-aos="zoom-in" style="background-image: url(<?php echo esc_attr( $background_image_url ); ?>)">
