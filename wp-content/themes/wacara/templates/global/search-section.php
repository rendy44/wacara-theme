			...
			<div class="col-lg-8 col-md-10 mx-auto text-center">
				...
				<div class="row mb-3">
					<div class="col-md-9 form-group">
						<input id="input_find_participant" class="form-control form-control-lg form-control-underlined" type="email" placeholder="<?php esc_attr_e( 'Enter your booking code', 'wacara' ); ?>">
					</div>
